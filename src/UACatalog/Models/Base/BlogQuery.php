 ...
 * @method     ChildBlogQuery orderByImage($order = Criteria::ASC) Order by the image column
 *
 ...
 * @method     ChildBlogQuery groupByImage() Group by the image column
 *
 ...
 * @method     ChildBlog findOneByImage(string $image) Return the first ChildBlog filtered by the image column *
 ...
 * @method     ChildBlog requireOneByImage(string $image) Return the first ChildBlog filtered by the image column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildBlog[]|ObjectCollection findByImage(string $image) Return ChildBlog objects filtered by the image column
...
abstract class BlogQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT id, title, text, image FROM blog WHERE id = :p0';
        try {
    ...
    public function filterByImage($image = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(BlogTableMap::COL_IMAGE, $image, $comparison);
    }
