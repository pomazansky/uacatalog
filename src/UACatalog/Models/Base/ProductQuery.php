 ...
 *
 * @method     ChildProductQuery leftJoinManufacturer($relationAlias = null) Adds a LEFT JOIN clause to the query using the Manufacturer relation
...
abstract class ProductQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \UACatalog\Models\Base\ProductQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\UACatalog\\Models\\Product', $modelAlias = null)
    {
    ...
    public function filterByManufacturerId($manufacturerId = null, $comparison = null)
    {
        if (is_array($manufacturerId)) {
            ...
            if (isset($manufacturerId['min'])) {
                $this->addUsingAlias(ProductTableMap::COL_MANUFACTURER_ID, $manufacturerId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($manufacturerId['max'])) {
                $this->addUsingAlias(ProductTableMap::COL_MANUFACTURER_ID, $manufacturerId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(ProductTableMap::COL_MANUFACTURER_ID, $manufacturerId, $comparison);
    }

    /**
     * Filter the query by a related \UACatalog\Models\Category object
     *
     * @param \UACatalog\Models\Category|ObjectCollection $category The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    {
        if ($category instanceof \UACatalog\Models\Category) {
            return $this
            ...
            throw new PropelException('filterByCategory() only accepts arguments of type \UACatalog\Models\Category or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \UACatalog\Models\CategoryQuery A secondary query class using the current class as primary query
     */
    public function useCategoryQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinCategory($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Category', '\UACatalog\Models\CategoryQuery');
    }

    /**
     * Filter the query by a related \UACatalog\Models\Manufacturer object
     *
     * @param \UACatalog\Models\Manufacturer|ObjectCollection $manufacturer The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    {
        if ($manufacturer instanceof \UACatalog\Models\Manufacturer) {
            return $this
                ->addUsingAlias(ProductTableMap::COL_MANUFACTURER_ID, $manufacturer->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(ProductTableMap::COL_MANUFACTURER_ID, $manufacturer->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
            throw new PropelException('filterByManufacturer() only accepts arguments of type \UACatalog\Models\Manufacturer or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \UACatalog\Models\ManufacturerQuery A secondary query class using the current class as primary query
     */
